...
\input{edit/00_information}

% Glossary inputs
\input{edit/glossary}

% Abstracts
%\input{edit/03_abstract-persian}
%\input{edit/04_abstract-english}
...
%	\makeCoverPersian
	...
	% Dedication page
	%\include{edit/01_dedication}
	
	% Acknowledgements page
	%\include{edit/02_acknowledgement}
...
%	\include{edit/chapters/4-evaluation}
 %   \include{edit/chapters/5-conclusion}
  ...
  %  \begin{appendices}
   % 	\tocless
    %	\include{edit/chapters/appendix}
    %\end{appendices}
